import { writeFileSync, mkdirSync } from "fs";  // Added mkdirSync for directory creation
...
export async function generateImageFromPrompt(prompt) {
    try {
        ...
        // Specify folder to save the image in (make sure the folder exists)
        ...
        try {
            ...
            console.log("Folder exists or created successfully.");
        } catch (err) {
